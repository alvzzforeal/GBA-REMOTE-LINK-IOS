...
struct VirtualControlsView: View {
    ...
    // Scale factor: 1.0 = base (390pt), up to 1.45 for Pro Max (430pt+)
    private var scale: CGFloat {
        min(screenSize.width / 390, 1.45)
    }

    private var controlsH: CGFloat { 178 * scale }
    private var dpadSize: CGFloat  { 126 * scale }
    private var abSize: CGFloat    { 116 * scale }
